...
internal class GroupAdminCommands(AppDbContext appDbContext) : IGroupAdminCommands
{
    ...
    public async Task ChangeGroupRequestableToAsync(GroupTbl group, bool isRequestable)
    {
        await TryToDoAsync(async () =>
        {
    ...
    public async Task UpdateDisplayIdAsync(GroupTbl group, DisplayId newDisplayId)
    {
        await TryToDoAsync(async () =>
        {
    ...
    public async Task UpdateInfoAsync(GroupTbl group, string title, string description)
    {
        await TryToDoAsync(async () =>
        {
